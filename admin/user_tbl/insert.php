...
{	
	...
	mysqli_query($con,"insert into login(`uid`,`username`,`password`,`type`) values('$uid','$_POST[username]','$_POST[password]','student')");
	mysqli_query($con,"INSERT INTO `bio`(`uid`) VALUES ('$uid')");
