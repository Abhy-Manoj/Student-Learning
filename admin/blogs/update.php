 ...
 elseif($i==5)
  {
	  ...
	  echo "<div class='col-md-10'>
              <div class='form-group'>
				  ...
				  <select name='$name' value='$datas' class='form-control'>
					<option>$datas</option>
					<option>Male</option>
 ...
 elseif($i==30 )
  {
	  ...
	  <div class='col-md-10'>".str_replace('_', ' ', $name)."</div><div class='col-sm-4'> ";
  ...
  {
	  echo "<div class='col-sm-10'><div class='form-group'><label>
