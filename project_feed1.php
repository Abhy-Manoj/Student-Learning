...
if (isset($_POST['post'])) {
	...
	if ($up1) {
		echo "<script>window.location.href='project_single.php?id=$project';</script>";
	}
}
					...
					<li class="post-comment">
						<div class="post-comt-box"> <br>
							<form method="post">
								...
								<textarea style="border-radius: 5px;" placeholder="Post your comment" name="comment"></textarea> <br>
